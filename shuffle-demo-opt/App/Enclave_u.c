...
sgx_status_t setup_phase(sgx_enclave_id_t eid, uint32_t* p_return_ptr, size_t len, int num, int buckets)
{
	sgx_status_t status;
	ms_setup_phase_t ms;
...
sgx_status_t compute_histogram(sgx_enclave_id_t eid, int* cipher_arr, size_t len, int num, int buckets)
{
	sgx_status_t status;
